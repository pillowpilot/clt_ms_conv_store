namespace WebApi.Integration.Commands.OpenTicket;
...
//public class OpenTicketCommandConsumer : IConsumer<OpenTicketCommand>
//{
//    public async Task Consume(ConsumeContext<OpenTicketCommand> context)
//    {
